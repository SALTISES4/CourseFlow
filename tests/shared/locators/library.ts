...
export function sortResetButton(page: Page, toolbar: Locator = libraryFilterToolbar(page)): Locator {
  return toolbar.getByRole('button', { name: 'close', exact: true });
}
...
export function typeFilterResetButton(page: Page): Locator {
  return typeFilter(page).locator('..').getByRole('button', { name: 'close', exact: true });
}
...
export function workflowTypeFilterAllOption(page: Page): Locator {
  return workflowTypeFilterPopover(page).getByRole('button', { name: 'All', exact: true });
}

export function workflowTypeFilterNoneOption(page: Page): Locator {
  return workflowTypeFilterPopover(page).getByRole('button', { name: 'None', exact: true });
}
...
export function workflowTypeFilterCheckboxOption(page: Page, label: string): Locator {
  return workflowTypeFilterCheckboxOptions(page).filter({ hasText: label, exact: true });
}
...
export async function closeWorkflowTypeFilterPopover(page: Page): Promise<void> {
  await page.keyboard.press('Escape');
  await expect(workflowTypeFilterAllOption(page)).toBeHidden();
}

export async function workflowTypeFilterOptionLabels(page: Page): Promise<string[]> {
...
export function disciplineFilterPopover(page: Page): Locator {
  return page.locator('.MuiPopover-root').filter({ has: page.getByLabel(DISCIPLINE_SEARCH_LABEL) });
}
...
export function disciplineFilterAllOption(page: Page): Locator {
  return disciplineFilterPopover(page).getByRole('button', { name: 'All', exact: true });
}

/** canonical: disciplineFilterNoneOption */
export function disciplineFilterNoneOption(page: Page): Locator {
  return disciplineFilterPopover(page).getByRole('button', { name: 'None', exact: true });
}
...
export function disciplineFilterCheckboxOption(page: Page, label: string): Locator {
  return disciplineFilterCheckboxOptions(page).filter({ hasText: label, exact: true });
}
...
export async function disciplineFilterOptionLabels(page: Page): Promise<string[]> {
...
export async function expectExploreErrorStateInResultsRegion(page: Page): Promise<void> {
...
export function libraryResultsProjectCards(page: Page): Locator {
  return page.locator('[data-test-id="library-results"] [data-test-id="project-card"]');
}

/** workflowCard instances within resultsRegion */
export function libraryResultsWorkflowCards(page: Page): Locator {
  return page.locator('[data-test-id="library-results"] [data-test-id="workflow-card"]');
}
...
export function paginationPreviousButton(page: Page): Locator {
  return libraryPagination(page).getByRole('button', { name: 'Go to previous page' });
}

/** canonical: paginationPreviousNextButton — next page control */
export function paginationNextButton(page: Page): Locator {
  return libraryPagination(page).getByRole('button', { name: 'Go to next page' });
}
...
export function paginationFirstButton(page: Page): Locator {
  return libraryPagination(page).getByRole('button', { name: 'Go to first page' });
}
...
export function paginationLastButton(page: Page): Locator {
  return libraryPagination(page).getByRole('button', { name: 'Go to last page' });
}
