            ...
            <div class="comment-box" onClick={(evt)=>evt.stopPropagation()} onMouseDown={(evt)=>evt.stopPropagation()}>
                ...
                {(this.props.renderer.add_comments) &&
                    <div class="comment-input-line">
                        ...
                        <img ref={this.submit} src={config.icon_path+"add_new.svg"} class="add-comment-button hidden hover-shade" onClick={this.appendComment.bind(this)} title={gettext("Submit")}/>
                    </div>
                }
            </div>,
            tag_box,
