...
class OutcomeTopView extends EditableComponent{
    ...
    render(){
        ...
        var selector = this;
        let share;
        if(!this.props.renderer.read_only)share = <div id="share-button" class="floatbardiv" onClick={renderMessageBox.bind(this,data,"share_menu",closeMessageBox)}><img src={config.icon_path+"add_person.svg"}/><div>Sharing</div></div>
