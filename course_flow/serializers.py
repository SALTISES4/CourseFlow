...
class OutcomeSerializerJ(serializers.ModelSerializer):
...
class OutcomeWithChildrenSerializer(serializers.ModelSerializer):
    children = OutcomeSerializerJ(many=True) # Recursively serialize children
    ...
    def to_representation(self, instance):
        ...
        filtered_children = [
            child for child in children if not child.get('deleted', False)
        ]

        representation['children'] = filtered_children
