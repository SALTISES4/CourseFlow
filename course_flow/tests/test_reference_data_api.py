...
def test_reference_data_returns_semantic_codes_without_presentation_labels(
    ...
    body = response.json()
    assert {"code": "biology"} in body["disciplines"]
    assert body["activityContexts"] == [
        {"value": ContextClassification.NONE},
        {"value": ContextClassification.INDIVIDUAL_WORK},
        {"value": ContextClassification.WORK_IN_GROUPS},
        {"value": ContextClassification.IN_THE_CLASSROOM},
    ]
