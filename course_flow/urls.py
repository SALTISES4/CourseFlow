...
def course_flow_patterns():
    return [
        ...
        path(
            "comments/add/",
            views.json_api.create_api.json_api_post_add_comment,
        ...
        path(
            ...
            views.json_api.create_api.json_api_post_new_outcome_for_workflow,
            name="json-api-post-new-outcome-for-workflow",
        ),
        path(
            "workflow/strategy/add",
            views.json_api.create_api.json_api_post_add_strategy,
        ...
        path(
            ...
            views.json_api.create_api.json_api_post_insert_sibling,
            name="json-api-post-insert-sibling",
        ),
        path(
            "workflow/insert-child/",
            views.json_api.create_api.json_api_post_insert_child,
            name="json-api-post-insert-child",
        ),
        path(
            "terminology/add/",
            views.json_api.create_api.json_api_post_add_object_set,
            name="json-api-post-add-object-set",
        ),
        # Register delete JSON routes
        path(
            "workflow/delete-self/",
            views.json_api.delete_api.json_api_post_delete_self,
            name="json-api-post-delete-self",
        ),
        path(
            "workflow/restore-self/",
            views.json_api.delete_api.json_api_post_restore_self,
            name="json-api-post-restore-self",
        ),
        path(
            "workflow/delete-self-soft/",
            views.json_api.delete_api.json_api_post_delete_self_soft,
            name="json-api-post-delete-self-soft",
        ),
        path(
            "workflow/delete-self-live/",
            views.json_api.delete_api.json_api_post_delete_self_live,
            name="json-api-post-delete-self-live",
        ),
        path(
            "comments/remove/",
            views.json_api.delete_api.json_api_post_remove_comment,
            name="json-api-post-remove-comment",
        ),
        path(
            "comments/removeall/",
            views.json_api.delete_api.json_api_post_remove_all_comments,
            name="json-api-post-remove-all-comments",
        ),
        # Register Duplication JSON routes
        path(
            "project/duplicate-workflow/",
            views.json_api.duplication_api.json_api_post_duplicate_workflow,
            name="json-api-post-duplicate-workflow",
        ),
        path(
            "project/duplicate-strategy/",
            views.json_api.duplication_api.json_api_post_duplicate_strategy,
            name="json-api-post-duplicate-strategy",
        ),
        path(
            "project/duplicate-project/",
            views.json_api.duplication_api.json_api_post_duplicate_project,
            name="json-api-post-duplicate-project",
        ),
        path(
            "workflow/duplicate-self/",
            views.json_api.duplication_api.json_api_post_duplicate_self,
            name="json-api-post-duplicate-self",
        ),
        # Register export/import JSON routes
        path(
            "imports/import-data/",
            views.json_api.export_import_api.json_api_post_import_data,
            name="json-api-post-import-data",
        ),
        path(
            "exports/get/",
            views.json_api.export_import_api.json_api_post_get_export,
            name="json-api-post-get-export",
        ),
        # Register live project JSON routes
        path(
            "project/makelive",
            views.json_api.live_project_api.json_api_post_make_project_live,
            name="json-api-post-make-project-live",
        ),
        path(
            "liveproject/getliveprojectdatastudent",
            views.json_api.live_project_api.json_api_post_get_live_project_data_student,
            name="json-api-post-get-live-project-data-student",
        ),
        path(
            "liveproject/getliveprojectdata",
            views.json_api.live_project_api.json_api_post_get_live_project_data,
            name="json-api-post-get-live-project-data",
        ),
        path(
            "liveproject/createliveassignment",
            views.json_api.live_project_api.json_api_post_create_live_assignment,
            name="json-api-post-create-live-assignment",
        ),
        path(
            "liveproject/getassignmentdatastudent",
            views.json_api.live_project_api.json_api_post_get_assignment_data_student,
            name="json-api-post-get-assignment-data-student",
        ),
        path(
            "liveproject/getassignmentdata",
            views.json_api.live_project_api.json_api_post_get_assignment_data,
            name="json-api-post-get-assignment-data",
        ),
        path(
            "liveproject/getworkflownodes",
            views.json_api.live_project_api.json_api_post_get_workflow_nodes,
            name="json-api-post-get-workflow-nodes",
        ),
        path(
            "assignment/getassignmentsfornode/",
            views.json_api.live_project_api.json_api_post_get_assignments_for_node,
            name="json-api-post-get-assignments-for-node",
        ),
        path(
            "liveprojectroles/set",
            views.json_api.live_project_api.json_api_post_set_liveproject_role,
            name="json-api-post-set-liveproject-role",
        ),
        path(
            "assignment/addusers/",
            views.json_api.live_project_api.json_api_post_add_users_to_assignment,
            name="json-api-post-add-users-to-assignment",
        ),
        path(
            "project/get-users-for-liveproject/",
            views.json_api.live_project_api.json_api_post_get_users_for_liveproject,
            name="json-api-post-get-users-for-liveproject",
        ),
        path(
            "liveproject/workflowvisibility",
            views.json_api.live_project_api.json_api_post_set_workflow_visibility,
            name="json-api-post-set-workflow-visibility",
        ),
        path(
            "liveproject/updatevalue/",
            views.json_api.live_project_api.json_api_post_update_liveproject_value,
            name="json-api-post-update-liveproject-value",
        ),
        path(
            "assignment/setcompletion/",
            views.json_api.live_project_api.json_api_post_set_assignment_completion,
            name="json-api-post-set-assignment-completion",
        ),
        # Register old courseflow import JSON route
        path(
            "project/from-json/",
            views.json_api.old_courseflow_import_api.json_api_post_project_from_json,
            name="json-api-post-project-from-json",
        ),
        # Register sharing JSON routes
        path(
            "permissions/set",
            views.json_api.sharing_api.json_api_post_set_permission,
            name="json-api-post-set-permission",
        ),
        path(
            "project/get-users-for-object/",
            views.json_api.sharing_api.json_api_post_get_users_for_object,
            name="json-api-post-get-users-for-object",
        ),
        path(
            "users/get-user-list/",
            views.json_api.sharing_api.json_api_post_get_user_list,
