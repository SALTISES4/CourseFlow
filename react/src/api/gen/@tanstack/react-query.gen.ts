...
import type {
  ...
  GetPublicGraphViewResponse,
  GetPublicWorkflowData,
  GetPublicWorkflowResponse,
  ...
  UpdateWorkflowPublicLinkResponse,
 ...
 */
export const updateWorkflowPublicLinkMutation = (
  options?: Partial<Options<UpdateWorkflowPublicLinkData>>
): UseMutationOptions<
  UpdateWorkflowPublicLinkResponse,
  DefaultError,
  Options<UpdateWorkflowPublicLinkData>
> => {
  const mutationOptions: UseMutationOptions<
    UpdateWorkflowPublicLinkResponse,
    DefaultError,
...
export const getPublicWorkflowQueryKey = (
  options: Options<GetPublicWorkflowData>
) => createQueryKey('getPublicWorkflow', options)

/**
 * Get Public Workflow
 */
export const getPublicWorkflowOptions = (
  options: Options<GetPublicWorkflowData>
) =>
  queryOptions<
    GetPublicWorkflowResponse,
    DefaultError,
    GetPublicWorkflowResponse,
    ReturnType<typeof getPublicWorkflowQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
...
export const getPublicGraphViewQueryKey = (
  options: Options<GetPublicGraphViewData>
) => createQueryKey('getPublicGraphView', options)

/**
 * Get Public Graph View
 */
export const getPublicGraphViewOptions = (
  options: Options<GetPublicGraphViewData>
) =>
  queryOptions<
    GetPublicGraphViewResponse,
    DefaultError,
    GetPublicGraphViewResponse,
    ReturnType<typeof getPublicGraphViewQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
...
export const getReferenceDataQueryKey = (
  options?: Options<GetReferenceDataData>
) => createQueryKey('getReferenceData', options)

/**
 * Get Reference Data
 */
export const getReferenceDataOptions = (
  options?: Options<GetReferenceDataData>
) =>
  queryOptions<
    GetReferenceDataResponse,
    DefaultError,
    GetReferenceDataResponse,
    ReturnType<typeof getReferenceDataQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
