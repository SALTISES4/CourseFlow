 ...
 */
export const zDisciplineListItemOut = z.object({
    id: z.number().int(),
    label: z.string(),
...
export const zProjectDetailOut = z.object({
    ...
    disciplines: z.array(zDisciplineListItemOut).optional(),
    workflows: z.array(zProjectWorkflowListItemOut).optional(),
    permissions: zPermissionContextOut
});
...
export const zProjectUpdateIn = z.object({
    ...
    disciplines: z.array(z.number().int()).nullish()
});
