 ...
 */
export const zWorkflowPublicLinkIn = z.object({
  enabled: z.boolean()
})
 ...
 */
export const zPublicWorkflowDetailOut = z.object({
  uuid: z.string().uuid(),
  graphUuid: z.string().uuid(),
  title: z.string(),
  description: z.string(),
 ...
 */
export const zPublicWorkflowDetailOutResp = z.object({
  item: zPublicWorkflowDetailOut
})
...
export const zChannelGraphOut = z.object({
  ...
  graphUuid: z.string().uuid(),
  title: z.string(),
  systemLabelCode: z.string().nullish(),
  titleCopyCount: z.number().int().optional().default(0),
 ...
 */
export const zContextClassification = z.enum([
  'none',
  'individual_work',
  'work_in_groups',
  'in_the_classroom',
 ...
 */
export const zTaskClassification = z.enum([
  'none',
  'gather_information',
  'discuss',
  'problem_solve',
  ...
  'experiment_inquiry',
  'quiz_test',
  'instructor_resource_curation',
  'instructor_orchestration',
...
export const zNodeGraphOut = z.object({
  ...
  titleCopyCount: z.number().int().optional().default(0),
  description: z.string().optional().default(''),
  contextClassification: zContextClassification.nullish(),
  taskClassification: zTaskClassification.nullish(),
...
export const zNotificationItemOut = z.object({
  ...
  messageParams: z.record(z.unknown()),
  legacyMessage: z.string().nullable(),
  isRead: z.boolean(),
  dateCreated: z.string().datetime()
})
 ...
 */
export const zContextReferenceOptionOut = z.object({
  value: zContextClassification
})

/**
 * DisciplineReferenceOptionOut
 */
export const zDisciplineReferenceOptionOut = z.object({
  code: z.string()
})
 ...
 */
export const zTaskReferenceOptionOut = z.object({
  value: zTaskClassification
})

/**
 * TimeUnitReferenceOptionOut
 */
export const zTimeUnitReferenceOptionOut = z.object({
  value: zTimeUnit
})
 ...
 * ReferenceDataOut
 */
export const zReferenceDataOut = z.object({
  disciplines: z.array(zDisciplineReferenceOptionOut).optional(),
  activityContexts: z.array(zContextReferenceOptionOut).optional(),
  courseContexts: z.array(zContextReferenceOptionOut).optional(),
  activityTaskClassifications: z.array(zTaskReferenceOptionOut).optional(),
...
export const zUpdateWorkflowPublicLinkData = z.object({
  body: zWorkflowPublicLinkIn,
  path: z.object({
    uuid: z.string().uuid()
  }),
  query: z.never().optional()
 ...
 * OK
 */
export const zUpdateWorkflowPublicLinkResponse = zWorkflowDetailOutResp
...
export const zGetPublicWorkflowData = z.object({
  body: z.never().optional(),
  path: z.object({
    uuid: z.string().uuid()
  }),
 ...
 * OK
 */
export const zGetPublicWorkflowResponse = zPublicWorkflowDetailOutResp

export const zGetPublicGraphViewData = z.object({
  body: z.never().optional(),
  path: z.object({
    uuid: z.string().uuid()
  }),
 ...
 * OK
 */
export const zGetPublicGraphViewResponse = zGraphViewOut
...
export const zGetReferenceDataData = z.object({
  body: z.never().optional(),
  path: z.never().optional(),
  query: z.never().optional()
})
