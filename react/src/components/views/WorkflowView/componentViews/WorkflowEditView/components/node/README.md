this folder is a collection of all the components to do with
workflow 'nodes'
these are the little boxes on the workflow connected by arrows
they are abstract wrappers around other content
they are not workflows, but they can contain references to workflows
