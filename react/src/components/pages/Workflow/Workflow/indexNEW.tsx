...
class Workflow {
  ...
  constructor(props) {
    ...
    if (this.public_view) {
      this.getWorkflowData = getPublicWorkflowDataQuery
      this.getWorkflowParentData = getPublicWorkflowParentDataQuery
      this.getWorkflowChildData = getPublicWorkflowChildDataQuery
    } else {
      this.getWorkflowData = getWorkflowDataQuery
      this.getWorkflowParentData = getWorkflowParentDataQuery
      this.getWorkflowChildData = getWorkflowChildDataQuery
    }
