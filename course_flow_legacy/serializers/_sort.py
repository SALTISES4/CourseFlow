from course_flow_legacy.serializers.container import (
    ColumnSerializerShallow,
    NodeWeekSerializerShallow,
    WeekSerializerShallow,
)
from course_flow_legacy.serializers.node import (
    NodeLinkSerializerShallow,
    NodeSerializerShallow,
)
from course_flow_legacy.serializers.outcome import (
    OutcomeOutcomeSerializerShallow,
    OutcomeSerializerShallow,
    OutcomeWorkflowSerializerShallow,
)
from course_flow_legacy.serializers.project import ProjectSerializerShallow
from course_flow_legacy.serializers.workflow import (
    ActivitySerializerShallow,
    CourseSerializerShallow,
    ProgramSerializerShallow,
    WorkflowSerializerShallow,
)
from course_flow_legacy.serializers.workflow_objects import (
    ColumnWorkflowSerializerShallow,
    WeekWorkflowSerializerShallow,
)
from course_flow_legacy.serializers.workspace import ObjectSetSerializerShallow
